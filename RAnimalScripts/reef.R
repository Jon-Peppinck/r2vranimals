...
# Define image paths
image_paths <- c("../images/reef/100030039.jpg", "../images/reef/120261897.jpg", "../images/reef/130030287.jpg", "../images/reef/130050093.jpg")
...
reef_contexts <- c("img1", "img2", "img3", "img4")
